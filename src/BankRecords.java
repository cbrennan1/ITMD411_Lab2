...
public class BankRecords extends Client {
	...
	public void setSave_act(final String save_act) {
	...
	public void setCurrent_act(final String current_act) {
	...
	public void setPep(final String pep) {
		this.pep = pep;
	}
	...
	public void processData() {
		 ...
		 */
		for (final List<String> rowData : array) {
